...
const PLUGIN_NAME = 'FlexDashboardPlugin';

export default class FlexDashboardPlugin extends FlexPlugin {
  constructor() {
    super(PLUGIN_NAME);
  }
  ...
  async init(flex: typeof Flex, manager: Flex.Manager): Promise<void> {
    ...
    // flex.AgentDesktopView.Panel1.Content.add(<CustomTaskList key="FlexDashboardPlugin-component" />, options);
